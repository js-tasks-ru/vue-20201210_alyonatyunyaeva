<template>
  <div class="dropdown" :class="{show : showMenu}">
    <button  
      ...
      @click="togleShowMenu"
    >
      <app-icon v-if="titleIcon" :icon="titleIcon" />
      {{ title }} <span v-if="titleText">- {{ titleText }}</span>
    </button>

    <div class="dropdown__menu" :class="{show : showMenu}">
      <button 
...
export default {
  ...
  computed: {
    ...
    titleText(){
      if(!this.catalogue[this.value]){
        return '';
      } else{
        console.log('this.catalogue[this.value].text', this.catalogue[this.value].text);
        return this.catalogue[this.value].text
      }
    },
    titleIcon(){
       if(!this.catalogue[this.value]){
        ...
        return this.catalogue[this.value].icon;
      };
    },
  },
  methods: {
